...
export { postTypeService } from './services/postTypeService'
export { pageTypeService } from './services/pageTypeService'
...
export type { PostType, PostTypeFormData } from './services/postTypeService'
export type { PageType, PageTypeFormData } from './services/pageTypeService'
