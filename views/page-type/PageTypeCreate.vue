...
const handleSubmit = async () => {
  try {
    ...
    const response: any = await pageTypeService.create(form)
    toastService.success('Oldal típus sikeresen létrehozva')
    ...
    console.error('Hiba az oldal típus létrehozásakor:', error)
  } finally {
...
<template>
  <AdminLayout page-title="Új oldal típus">
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>Add meg az új oldal típus adatait</CardDescription>
      </CardHeader>
